...
One-way `.ipynb` import for migration from existing Jupyter notebooks. Supports nbformat v4+, maps code/markdown/raw cell types, and preserves execution count metadata.
