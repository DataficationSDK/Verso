...
Built-in formatters handle primitives, collections (as HTML tables), HTML strings, images, SVG, exceptions, Microsoft.Data.Analysis DataFrames, F# types, and SQL result sets.
