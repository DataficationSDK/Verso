    ...
    public async Task<string> DispatchAsync(object id, string method, JsonElement? @params)
    {
        try
        {
            object? result = method switch
            {
                ...
                MethodNames.CellChangeType => CellHandler.HandleChangeType(this, @params),
                ...
                MethodNames.NotebookGetCellTypes => NotebookHandler.HandleGetCellTypes(this),
                MethodNames.LayoutGetLayouts => LayoutHandler.HandleGetLayouts(this),
                MethodNames.LayoutSwitch => LayoutHandler.HandleSwitch(this, @params),
                MethodNames.LayoutRender => await LayoutHandler.HandleRenderAsync(this),
                MethodNames.LayoutGetCellContainer => await LayoutHandler.HandleGetCellContainerAsync(this, @params),
                MethodNames.LayoutUpdateCell => LayoutHandler.HandleUpdateCell(this, @params),
                ...
                MethodNames.ToolbarGetEnabledStates => await ToolbarHandler.HandleGetEnabledStatesAsync(this, @params),
                MethodNames.ToolbarExecute => await ToolbarHandler.HandleExecuteAsync(this, @params),
